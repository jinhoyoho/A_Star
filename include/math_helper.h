 ...
 * @param node1 Node 1
 * @param node2 Node 2
 * @return the angle of x-axis between the 2 nodes
 */
 ...
 * @param theta    the angle to modulate
 * @return theta_m the angle after modulus operation
 */
 ...
 * @param p1/p2     the two points in the segment
 ...
 * @param cal     The custom calculated function
...
/**
 * @brief Find the first element in iterator that is greater than the integrated distance compared to a value
 * @param begin   The begin of iterator
 * @param end     The end of iterator
 * @param dist    The distance metric function
 * @param cmp_val The compared value
 * @return it     The first element in iterator that is greater than integrated distance compared to value
 */
